...
wk.register({
  ...
  f = {
    ...
    f = { "<cmd>FloatermFirst<cr>", "First floaterm"},
    l = { "<cmd>FloatermLast<cr>", "Last floaterm"},
    ...
    g = { "<cmd>FloatermNew! --height=0.98 --width=0.98 --wintype=float --name=lazygit --position=center --autoclose=1 lazygit<cr>", "lazygit"},
    t = { "<cmd>FloatermNew! --height=0.98 --width=0.98 --wintype=float --name=lazygit --position=center --autoclose=1 tig<cr>", "tig"},
    a = { "<cmd>FloatermNew! --height=0.98 --width=0.98 --wintype=float --name=lazygit --position=center --autoclose=1 tig --all<cr>", "tig all reference"},
  },
  t = {
    name = "Telescope",
  ...
  g = {
    ...
    E = { "<cmd>GitGutterBufferEnable<cr>", "Buffer enable" },
    t = { "<cmd>GitGutterBufferToggle<cr>", "Buffer toggle" },
  },
  n = {
    name = "Neogit",
    o = { function() neogit.open() end, 'Open Neogit' },
    c = { function() neogit.open({ "commit" }) end, 'Open Neogit commit window' },
    h = { function() neogit.open({ kind = "split" }) end, 'Open horizontal' },
    v = { function() neogit.open({ kind = "vsplit" }) end, 'Open vertical' },
    t = { function() neogit.open({ kind = "tab" }) end, 'Open in tab' },
